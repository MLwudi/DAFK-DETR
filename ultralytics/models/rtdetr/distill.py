...
class RTDETRDistiller(RTDETRTrainer):
    ...
    def _setup_train(self, world_size):
        ...
        if self.args.kd_loss_type == 'logical' or self.args.kd_loss_type == 'all':
            ...
            elif self.args.logical_loss_type == 'mutillogical':
    ...
    def _do_train(self, world_size=1):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            if self.args.kd_loss_type in ['feature', 'all'] and epoch <= stop_kd_epoch:
                ...
                s_feature_idx = [s_feature_idx.index(i) for i in s_feature_sort_idx]
                t_feature_idx = [t_feature_idx.index(i) for i in t_feature_sort_idx]
